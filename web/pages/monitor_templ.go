...
func MonitorInitial() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/pages/monitor.templ`, Line: 28, Col: 52}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var3))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "\" class=\"h-screen flex justify-center items-center\" data-signals=\"{memTotal:&#39;&#39;, memUsed:&#39;&#39;, memUsedPercent:&#39;&#39;, cpuUser:&#39;&#39;, cpuSystem:&#39;&#39;, cpuIdle:&#39;&#39;}\"><div class=\"border border-primary rounded flex gap-10 p-2\"><div id=\"mem\" class=\"flex flex-col min-w-40 max-w-40\"><h1 class=\"text-center pb-2 text-xl\">Memory</h1><p class=\"flex justify-between\"><span>Total:</span> <span data-text=\"$memTotal\"></span></p><p class=\"flex justify-between\"><span>Used:</span> <span data-text=\"$memUsed\"></span></p><p class=\"flex justify-between\"><span>%: </span> <span data-text=\"$memUsedPercent\"></span></p></div><div id=\"cpu\" class=\"flex flex-col min-w-40 max-w-40\"><h1 class=\"text-center pb-2 text-xl\">CPU</h1><p class=\"flex justify-between\"><span>User:</span> <span data-text=\"$cpuUser\"></span></p><p class=\"flex justify-between\"><span>System:</span> <span data-text=\"$cpuSystem\"></span></p><p class=\"flex justify-between\"><span>Idle:</span> <span data-text=\"$cpuIdle\"></span></p></div></div></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
